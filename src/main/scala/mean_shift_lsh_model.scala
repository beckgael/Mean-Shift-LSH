...
class Mean_shift_lsh_model(val clustersCenter:Map[Int, Vector], val clustersCardinalities:scala.collection.Map[Int, Long], val labelizedRDD:RDD[(Int,(Long, Vector))] ,val maxMinArray:Array[Array[Double]]) extends Serializable {
