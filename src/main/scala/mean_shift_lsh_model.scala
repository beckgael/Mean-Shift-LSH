...
class Mean_shift_lsh_model(val clustersCenter:Map[Int, Vector], val labelizedRDD:RDD[(Int,(Long, Vector))] ,val maxMinArray:Array[Array[Double]]) extends Serializable {
